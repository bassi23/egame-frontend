<template>
  <div class="fixed level6-coral-tower">
    <img
    ...
    <div class="introContainer">
      <level-intro
        title="Attributionsquiz"
        :dialouge="dialouge"
        link="/level/6/benchmark-orientation/intro"
      />
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      dialouge: [
        {
          text: 'Malkia: Sehr gut. Dein Wissen beeindruckt mich sehr. Aber bei der nächsten Aufgabe mache ich es dir nicht so leicht.',
          position: 'left',
        },
      ],
    }
